    ...
    <article id="llistes">
      <div class="table-holder">
        ...
        <template id="templatebutton">
          <div class="botonsvocals columns">
      ...
      <br>
      <br>
      <form id="formllista" class="pc-columns-mobile-rows gap hidden">
        <div class="rows gap">
          <div>
        ...
        <div class="rows center">
          <button type="button" id="afegirvocal" class="neutre columns center">Afegir un/a vocal</button>
          <br>
