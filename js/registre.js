function validarFormulari(dades) {
    ...
    if (dades["nom"] == "") {
      ...
      registreLabels[0].classList.remove("error");
    }
    if (dades["cognom1"] == "") {
      ...
      registreLabels[1].classList.remove("error");
    }
    if (dades["cognom2"] == "") {
      document.forms["formregistre"]["cognom1"].focus();
      ...
      registreLabels[2].classList.remove("error");
    }
    if (dades["email"] == "") {
      ...
      registreLabels[4].classList.remove("error");
    }
    if (dades["password"] == "") {
      ...
      registreLabels[5].classList.remove("error");
    }
    if (dades["telefon"] == "") {
    ...
    if (data < datanaixement) {
      document.forms["formregistre"]["naixement"].focus();
      document.getElementById("missatge").textContent =
        "La data de naixement ha de ser anterior a la data actual";
      return false;
    }
    if (dades["treballador"] == "") {
      document.forms["formregistre"]["treballador"].focus();
      document.getElementById("missatge").textContent =
        "Has d'indicar si treballes a la universitat o no";
      return false;
    }
    return true;
  }
