<article id="loginform" class="form">
    ...
    <form name="formlogin" autocomplete="on" action="login.php" method=post>
        <div>
            ...
            <br>
            <input id="email" type="email" name="email" placeholder="<?php echo $email; ?>"
                pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
        </div>
        <div>
            <label class="form-input-label" for="password">Contrassenya</label>
            <br>
            <input id="password" type="password" name="password" placeholder="Contrasenya"
                autocomplete="current-password" pattern="[A-Za-z0-9.-_ ].{3,}" title="6 caracters minim, siusplau.">
        </div>
