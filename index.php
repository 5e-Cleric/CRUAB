...
<main class="main-content rows center">
    ...
    <article id="contingut" class="rows"></article>
    ...
    <article class="pc-columns-mobile-rows space-between">
        ...
        <div>
            ...
            <p>El CRUAB no té un edifici propi, pero compartim diverses zones amb la resta d'associacions de la UAB, la
                ...
                principal es l'hotel d'entitats, que es troba a l'edifici de la cafeteria de la plaça civica, al segon pís.
        ...
        <div class="iframe">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d235.29825383994833!2d2.1039607509874605!3d41.50208493918048!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x6fe6b1f4bf7cdee3!2zNDHCsDMwJzA3LjYiTiAywrAwNicxNC41IkU!5e0!3m2!1sen!2ses!4v1665258936878!5m2!1sen!2ses" width="300px" height="300px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
...
<template id="template">
    ...
    <div class="botons columns align">

        <button class="editar neutre rodo hidden">

            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">

                <path style="transform:translate(20%, 20%)" d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3
        ...
        <button class="cancelar destructiu rodo hidden">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 520 520">
                ...
                <path style="transform:translate(20%, 5%)" d="M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5
